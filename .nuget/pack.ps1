...
$version = [System.Reflection.Assembly]::LoadFile("$root\CommandContext\CommandContext.NetFramework\bin\Release\CommandContext.NetFramework.dll").GetName().Version
